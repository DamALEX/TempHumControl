...
void setup() {
  ...
  humidity = dht.readHumidity();          // Lecture de l'humidité en Pourcents
  Serial.print("Humidité: ");
  Serial.println(humidity);
  
  temp = dht.readTemperature(false);     // Lecture de la température en Celsius
